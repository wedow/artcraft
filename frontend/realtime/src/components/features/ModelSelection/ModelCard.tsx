  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full overflow-hidden">
        ...
        {isDownloading && (
          <div className="absolute inset-0 flex h-full w-full flex-col items-center justify-center bg-black/50">
            <div className="mb-2 text-center text-white">{progress}%</div>
            <div className="h-10 w-10 animate-spin text-white">
              <svg
