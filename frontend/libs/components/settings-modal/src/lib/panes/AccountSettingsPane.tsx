    ...
    <div className="space-y-4">
      ...
      <div className="rounded-md p-4 text-sm dark:bg-white/5">
        <p className="text-white/60">
          Note: You can optionally log into other accounts and use your credits
          at those providers. Some features are only available via 3rd party
          accounts, such as OpenAI / Sora GPT 4.0 Images. For other features,
          ArtCraft credits are consumed unless you log into your third party
          account.
        </p>
      </div>
