        ...
        <div className="w-full max-w-md bg-[#1C1C20] border border-white/10 rounded-3xl p-8 shadow-2xl">
           ...
           <div className="space-y-4">
              ...
              <div className="relative flex items-center justify-center py-2">
                 ...
                 <span className="relative bg-[#1C1C20] px-4 text-xs text-white/40 uppercase tracking-widest">or</span>
              </div>
               ...
               <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-white/60 uppercase tracking-wide ml-1">Email or Username</label>
                        <input 
                            type="text" 
                            value={email}
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center ml-1">
                           <label className="text-xs font-bold text-white/60 uppercase tracking-wide">Password</label>
                           <Link to="/forgot-password" className="text-xs text-primary hover:text-primary-400 transition-colors">Forgot password?</Link>
                        </div>
            ...
            <div className="mt-8 text-center text-sm text-white/60">
              ...
              <Link to="/signup" className="text-primary hover:text-primary-400 font-semibold transition-colors">
                Sign up
              </Link>
            </div>
