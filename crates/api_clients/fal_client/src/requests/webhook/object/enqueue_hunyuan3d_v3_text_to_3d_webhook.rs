...
use fal::endpoints::fal_ai::hunyuan3d::hunyuan3d_v3_text_to_3d::{hunyuan3d_v3_text_to_3d, Hunyuan3dV3TextTo3dInput};
...
pub enum EnqueueHunyuan3dV3TextTo3dGenerateType {
  Normal,
  LowPoly,
  Geometry,
}
...
#[derive(Copy, Clone, Debug)]
pub enum EnqueueHunyuan3dV3TextTo3dPolygonType {
  Triangle,
  Quadrilateral,
}
