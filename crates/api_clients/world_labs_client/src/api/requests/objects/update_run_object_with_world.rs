...
pub struct UpdateRunObjectWithWorldArgs<'a> {
  pub cookies: &'a WorldLabsCookies,
  pub bearer_token: &'a WorldLabsBearerToken,

  pub payload_args: UpdateRunObjectWithWorldPayloadArgs<'a>,

  pub request_timeout: Option<Duration>,
}

pub struct UpdateRunObjectWithWorldPayloadArgs<'a> {
  pub run_id: &'a RunObjectId,
  pub run_created_at_timestamp: u64,
  pub first_patch_timestamp: u64,
...
pub struct UpdateRunObjectWithWorldResponse {
...
impl RawRequest {
  pub fn from_args(args: &UpdateRunObjectWithWorldPayloadArgs) -> Self {
    ...
    request.add_image_input_node({
      ...
      node.title = args.title.to_string();
      node.caption = args.text_prompt.to_string();
...
struct ObjectMetadata {
  ...
  // NB: Not null in request, just for builder
...
struct WorldNodeSource {
  pub r#type: TypeGenerateWorld,
  // NB: Not null in request, just for
  pub world_id: Option<String>,
...
mod tests {
  ...
  use crate::api::api_types::meta_world_object_id::MetaWorldObjectId;
  use crate::api::api_types::world_id::WorldObjectId;
  use crate::api::requests::objects::update_run_object_with_world::{RawRequest, UpdateRunObjectWithWorldPayloadArgs};
