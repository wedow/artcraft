...
use crate::endpoints::webhook::webhook_event_enrichment::customer_subscription::extract_subscription_details::extract_subscription_details;
...
pub async fn customer_subscription_updated_handler(
  ...
  let summary = extract_subscription_details(subscription, server_environment)?;
