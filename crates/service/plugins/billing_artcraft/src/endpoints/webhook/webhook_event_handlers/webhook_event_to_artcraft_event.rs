...
use crate::endpoints::webhook::webhook_event_handlers::payment_intent::payment_intent_succeeded_handler_2::payment_intent_succeeded_handler_2;
...
pub async fn webhook_event_to_artcraft_event(
  ...
  match webhook_payload.data.object {
    ...
    EventObject::PaymentIntentSucceeded(payment_intent) => {
      ...
      return payment_intent_succeeded_handler_2(
        &payment_intent,
        server_environment,
        stripe_client,
      ).await;
