        ...
        >
{
    ...
    app =
        add_remote_download_routes(
            app
        ); /* /v1/remote_downloads (prev. /retrieval, aka. "generic_download_jobs") */
    ...
    app.service(
        ...
        .service(
            web
                ::resource("/server_info") // NB/TODO(bt,2023-01-21): Couldn't scope to /v1/, actix routing table might not like collision
        ...
        >
{
    app.service(
        web
            ...
            .service(
                web
                    ::resource("/model/{token}/delete")
                    .route(web::post().to(delete_tts_model_handler))
                    .route(web::head().to(|| HttpResponse::Ok()))
            )
            .service(
                web
                    ::resource("/model/{model_token}/count")
                    .route(web::get().to(get_tts_model_use_count_handler))
                    .route(web::head().to(|| HttpResponse::Ok()))
            )
            .service(
                web
                    ::resource("/model/{model_token}/edit")
            ...
            .service(
                web
                    ::resource("/result/{token}/edit")
                    .route(web::post().to(edit_tts_inference_result_handler))
                    .route(web::head().to(|| HttpResponse::Ok()))
            )
            .service(
                web
                    ::resource("/result/{token}/delete")
            ...
            .service(
                web
                    ::resource("/upload_model_job/{token}")
        ...
        >
{
    app.service(
        web
            ...
            .service(
                web
                    ::resource("/upload_template_job/{token}")
        ...
        >
{
    app.service(
        web
            ...
            .service(
                web::scope("/computed_assignments").service(
                    web
                        ::resource("/tts")
...
{
    app.service(
        web::scope("/flags").service(
            web
                ::scope("/design_refresh")
                .service(
                    web
                        ::resource("/enable")
...
{
    app.service(
        web::scope("/v1/media_files").service(
            web
                ::resource("/file/{token}")
        ...
        >
{
    app.service(
        web
            ...
            .service(
                web
                    ::resource("/by_session/{media_type}")
        ...
        >
{
    app.service(
        web
            ...
            .service(
                web
                    ::resource("/view/{entity_type}/{entity_token}")
...
{
    app.service(
        web::scope("/v1/subscriptions").service(
            web
                ::resource("/unsubscribe_reason")
