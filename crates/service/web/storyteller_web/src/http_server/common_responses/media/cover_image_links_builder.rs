...
impl CoverImageLinksBuilder {
  ...
  pub fn from_media_path(
    ...
    CoverImageLinksBuilder::from_rooted_path(domain, rooted_path)
  }
  ...
  pub fn from_maybe_media_path(
    ...
    match bucket_path {
      None => None,
      Some(bucket_path) => CoverImageLinksBuilder::from_media_path(domain, bucket_path),
    }
  }
  ...
  pub fn from_parts(
    ...
    CoverImageLinksBuilder::from_media_path(domain, &bucket_path)
  }
