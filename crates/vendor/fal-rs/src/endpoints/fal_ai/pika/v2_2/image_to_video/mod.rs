...
///
///
/// Pika 2.2 Image-to-Video Generation.
///
/// Transforms a static image into a dynamic video using the Pika 2.2 model.
/// This is Pika's highest quality model with support for resolution and duration options.
pub fn image_to_video(
    params: Pika22ImageToVideoRequest,
) -> FalRequest<Pika22ImageToVideoRequest, Pika22ImageToVideoOutput> {
    FalRequest::new("fal-ai/pika/v2.2/image-to-video", params)
}
