...
///
/// Generates a video from an initial image and text prompt using the Pika 2.1 model.
pub fn image_to_video(
    params: ImageToVideoRequest,
) -> FalRequest<ImageToVideoRequest, ImageToVideoOutput> {
    FalRequest::new("fal-ai/pika/v2.1/image-to-video", params)
}
