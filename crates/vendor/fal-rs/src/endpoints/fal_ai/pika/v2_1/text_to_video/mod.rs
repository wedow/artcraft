...
///
/// Generates a video from text description using the Pika 2.1 model.
pub fn text_to_video(
    params: TextToVideoRequest,
) -> FalRequest<TextToVideoRequest, TextToVideoOutput> {
    FalRequest::new("fal-ai/pika/v2.1/text-to-video", params)
}
