...
///
///
/// Pika 2.1 Collection-to-Video Generation.
///
/// Generates a video from multiple images and text prompt using the Pika 2.1 model.
pub fn collection_to_video(
    params: CollectionToVideoRequest,
) -> FalRequest<CollectionToVideoRequest, CollectionToVideoOutput> {
    FalRequest::new("fal-ai/pika/v2.1/collection-to-video", params)
}
