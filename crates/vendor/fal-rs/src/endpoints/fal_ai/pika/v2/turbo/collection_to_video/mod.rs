...
///
///
/// Pika Turbo Collection-to-Video Generation.
///
/// Generates a video from multiple images and text prompt using the Pika Turbo model.
pub fn collection_to_video(
    params: CollectionToVideoRequest,
) -> FalRequest<CollectionToVideoRequest, VideoOutput> {
    FalRequest::new("fal-ai/pika/v2/turbo/collection-to-video", params)
}
