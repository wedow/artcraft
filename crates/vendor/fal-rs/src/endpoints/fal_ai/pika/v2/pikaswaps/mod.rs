...
///
///
/// Pika Pikaswaps Generation.
///
/// Swap out any object or region of your video with a new image or object.
/// Define areas to replace with a text description.
pub fn pikaswaps(params: PikaswapsRequest) -> FalRequest<PikaswapsRequest, PikaswapsOutput> {
    FalRequest::new("fal-ai/pika/v2/pikaswaps", params)
}
