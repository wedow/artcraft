...
pub struct BytedanceSeedreamV4EditImageInput {
  pub prompt: String,
...
pub struct BytedanceSeedreamV4EditImageOutput {
...
pub fn bytedance_seedream_v4_edit_image(
  params: BytedanceSeedreamV4EditImageInput,
) -> FalRequest<BytedanceSeedreamV4EditImageInput, BytedanceSeedreamV4EditImageOutput> {
