...
///
///
/// Vidu Start-End to Video API: Generate a smooth transition video between start and end frames.
pub fn start_end_to_video(
    params: StartEndToVideoRequest,
) -> FalRequest<StartEndToVideoRequest, StartEndToVideoOutput> {
    FalRequest::new("fal-ai/vidu/start-end-to-video", params)
}
