...
pub struct BaseInput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub highres_denoise: Option<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hr_downscale: Option<f64>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub initial_latent: Option<String>,
    /// Strength for low-resolution pass.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub lowres_denoise: Option<f64>,
...
pub fn iclight_v2(params: BaseInput) -> FalRequest<BaseInput, Output> {
    FalRequest::new("fal-ai/iclight-v2", params)
}
