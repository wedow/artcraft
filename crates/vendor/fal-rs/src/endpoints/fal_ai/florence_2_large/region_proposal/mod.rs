...
pub fn region_proposal(params: ImageInput) -> FalRequest<ImageInput, BoundingBoxOutputWithLabels> {
    FalRequest::new("fal-ai/florence-2-large/region-proposal", params)
}
