        ...
        {(step?.options ?? []).map((option) => (
          <Fragment key={option.value}>
            {option.label === "Remix" && (
              <button
                className={twMerge(
                  "group relative flex h-[249px] w-full flex-col items-center rounded-lg border border-white/5 bg-brand-secondary/50 px-2 pt-[56px] transition-all duration-150 hover:border-brand-primary hover:bg-brand-primary/20",
                )}
