...
class Editor {
  ...
  render_camera_aspect_ratio: CameraAspectRatio = CameraAspectRatio.SQUARE_1_1;
  ...
  constructor() {
    ...
    this.render_camera_aspect_ratio = CameraAspectRatio.SQUARE_1_1;
    ...
    if (this.cameraViewControls && this.camera_person_mode) {
      if (this.cam_obj && this.camera) {
        if (this.last_scrub != this.timeline.scrubber_frame_position) {
          this.cameraViewControls.followObject.position.copy(this.cam_obj.position);
          this.camera.rotation.copy(this.cam_obj.rotation);
        } else if (!this.timeline.is_playing) {
          this.cam_obj.position.copy(this.cameraViewControls.followObject.position);
