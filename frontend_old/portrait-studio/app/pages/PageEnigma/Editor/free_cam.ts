...
class FreeCam extends EventDispatcher {
  ...
  followObject = new THREE.Object3D();
  ...
  constructor(
    ...
    this.followObject.position.copy(object.position);
  ...
  mousemove(event: MouseEvent) {
    ...
    if (this.dragging) {
      ...
      if (Math.abs(mouseX + mouseY) > 0) {
        this.followObject.translateX(-mouseX * (this.movementSpeed * 0.01));
        this.followObject.translateY(mouseY * (this.movementSpeed * 0.01));
      }
    }
  }
  ...
  mousewheel(event: WheelEvent) {
    ...
    this.followObject.translateZ(event.deltaY / 120); // 120 is the lowest mouse wheel rot.
  }
  ...
  update(delta: number) {
    ...
    this.followObject.rotation.copy(this.object.rotation);
    this.followObject.translateX(this.moveVector.x * moveMulti);
    this.followObject.translateY(this.moveVector.y * moveMulti);
    this.followObject.translateZ(this.moveVector.z * moveMulti);

    this.object.position.lerp(this.followObject.position, 0.1);
  }
