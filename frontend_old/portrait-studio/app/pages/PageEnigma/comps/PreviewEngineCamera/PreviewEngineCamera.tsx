...
export const PreviewEngineCamera = () => {
  ...
  return (
    <div
      ...
      className={twMerge(
        "w-fit origin-bottom-left overflow-hidden rounded-lg border-[4px] border-white/80 shadow-xl",
    ...
    >
      ...
      >
        <div
          className={twMerge(
            "origin -z-10 flex h-auto w-full flex-wrap items-center gap-1.5 bg-ui-panel p-2 text-white",
            cameraAspectRatio.value !== CameraAspectRatio.VERTICAL_9_16
              ? "justify-between"
